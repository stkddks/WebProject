...
<body>
	<form action="managerUpdate.jsp" method="get">
		<div class="member11">
			...
			<div class="form">
				<div class="form2">
					...
					<div class="form4">
						...
						<div class="clear"></div>
						<label for="user">부서</label> <input type="text" name="dept" id="user">
		
					</div>
						<input type="submit" value="수정하기" onclick='location.href="managerUpdate.jsp"'>
