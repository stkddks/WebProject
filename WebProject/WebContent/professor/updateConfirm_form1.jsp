...
<body>
	<form action="professorUpdate.jsp" method="get">
		<div class="member11">
		...
		<div id="wrap">
			<h1 class="member">member delete</h1>
			<div class="form">
				<div class="form2">
					<div class="form3">
						...
						//String sql = "select * from ProfessorA where name='" + updateName + "'";
					...
					<div class="form4">
						<input type="hidden" name="updateName"
							value="<%=updateName%>">
						<!-- 안보이게 날아가는 아이 -->
						<label for="user">이름</label> <input type="text" name="name" id="user">
						<div class="clear"></div>
						<label for="user">나이</label> <input type="text" name="age" id="user">
						<div class="clear"></div>
						<label for="user">과목</label> <input type="text" name="subject" id="user">
		
					</div>
						<input type="submit" value="수정하기" onclick='location.href="professortUpdate.jsp"'>
