	...
	<form action="boardSearch.jsp" method="get">
		...
		<div id="wrap">
			...
			<div class="form">
				<div class="form2">
					<div class="form3">
						<input type="hidden" name="boardTest"
							value="index.jsp?page=boardSearchForm"> <label for="user">찾을
							제목</label> <input type="text" name="title" autofocus="autofocus"
							required="required" placeholder="제목입력" id="user">
						<div class="clear"></div>
					...
					<table border="1" cellspacing="0" cellpadding="0">
						...
						<tr>
							<%
								out.print("<tr><td>" + no + "</td><td>" + title + "</td><td>" + content + "</td><td>" + author + "</td><td>" + nal
